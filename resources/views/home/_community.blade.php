...
<div class="col-md-6">
	<div class="title title--big" style="padding-top: 20px;">
		<h3><a href="#" class="hidden-xs">THE COMMUNITY</a></h3>
		<h4><a href="#" class="visible-xs align-center">COMMUNITY</a></h4>
	</div>
</div>
	...
	@for ($i = 0; $i < 8; $i++)
		<div class="col-md-3">
			<div class="panel panel-card uk-overlay uk-overlay-hover">
				...
				<span class="details"><i class="glyphicon glyphicon-bullhorn text-md"></i><b> Music</b></span>
        		</div>
