Raphael.fn.pieChart = function (cx, cy, r, values, stroke) {
    ...
    var angle = 90,
        ...
        process = function (j) {
            ...
            if(values[j] == 100) {
                var p = paper.circle(cx, cy, r).attr({fill: "#d01f4b", stroke: "#d01f4b", "stroke-width": 0});
            }else{
                if (j == 1) {
                    var p = sector(cx, cy, r, angle, angle + angleplus, {fill: "90-#d01f4b-#d01f4b", stroke: stroke, "stroke-width": 0});
                }else{
