$(function(){
	...
	$('#sys_lst_tweets').tweet({
			modpath: '/twitter/',
			count: 2,
			loading_text: '<p class="rs ta-c fc-white">Loading Twitter <br /><img src="http://localhost/rayakan/assets/public/images/ajax-loader.gif" alt="@rayakanID"/></p>',
			username: 'mechanical-city',
